...
function handleRouteChange(user) {
    ...
    switch (hash) {
        ...
        case '#accounts':
            ...
            break;
        case '#or-registry':
            window.renderORRegistrySection(mainContent, user);
            break;
        case '#messages':
            window.renderMessagesSection(mainContent, user);
            break;
        case '#fees':
            window.renderFeesSection(mainContent, user);
            break;
        default:
  ...
  body.innerHTML = `
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top">
      <div class="container-fluid">
        <a class="navbar-brand fw-bold" href="#dashboard">Manukan Waterworks System - Collection Section</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#or-registry">OR Management</a>
            </li>
            <li class="nav-item">
