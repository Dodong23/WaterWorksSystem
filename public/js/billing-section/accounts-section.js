 ...
 */
export function renderAccountsSection(mainContent, primaryMainContent, renderStatement) {
    // HTML Template
    const html = `
    <h3>Accounts</h3>
    ...
    <div class="table-responsive">
        <table class="table table-hover align-middle table-bordered" id="accounts-table">
